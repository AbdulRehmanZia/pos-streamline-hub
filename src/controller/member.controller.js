...
import { registerValidation, updateValidation } from "../utils/validationSchema.js";
...
export const updateStoreMember = async (req, res) => {
  try {
    ...
    return ApiResponse(res, 200, updatedMember, "Member Updated Successfully");
  } catch (error) {
