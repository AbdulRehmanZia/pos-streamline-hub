...
const Footer = () => {
  return (
    <footer className="bg-gradient-hero from-primary/90 to-primary/70 text-primary-foreground py-16">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          {/* Left side - POS Info */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-white/10 rounded-3xl shadow-lg">
                <Monitor className="w-8 h-8 text-white" />
              </div>
              <span className="text-1xl md:text-3xl font-bold tracking-normal">
                RetailPOS
              </span>
            </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            <div className="space-y-4 w-full max-w-sm flex flex-col justify-center">

            <h3 className="text-1xl md:text-3xl font-bold tracking-normal  text-center">
              Contact Us
            </h3>
              {/* WhatsApp */}
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-6 py-4 rounded-2xl border border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white transform hover:scale-105 transition-all shadow-md justify-center"
              >
              ...
              <a
                href="mailto:bootcamp.pos.sender@gmail.com"
                className="flex items-center gap-3 px-6 py-4 rounded-2xl border border-[#EA4335] text-[#EA4335] hover:bg-[#EA4335] hover:text-white transform hover:scale-105 transition-all shadow-md justify-center"
              >
                <SiGmail className="w-6 h-6" />
                <span className="font-medium text-base md:text-lg">
                  bootcamp.pos.sender@gmail.com
                </span>
              </a>
            </div>
          </div>
